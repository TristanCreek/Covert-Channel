...
def main():
    ...
    # Returns the paths to the image and data file to use
    ...
    extract_data(default_path_to_write_image, default_path_to_write_data)

    print("Hidden file extracted from image!")
